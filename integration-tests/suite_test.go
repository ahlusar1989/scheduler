...
func testAll(server *scheduling_service.Server, t *testing.T) {
...
func testSendTask(server *scheduling_service.Server, t *testing.T) {
...
func testSendGroup(server *scheduling_service.Server, t *testing.T, sendConcurrency int) {
...
func testSendChain(server *scheduling_service.Server, t *testing.T) {
...
func testSendChord(server *scheduling_service.Server, t *testing.T) {
...
func testReturnJustError(server *scheduling_service.Server, t *testing.T) {
...
func testReturnMultipleValues(server *scheduling_service.Server, t *testing.T) {
...
func testPanic(server *scheduling_service.Server, t *testing.T) {
...
func testDelay(server *scheduling_service.Server, t *testing.T) {
	now := time.Now().UTC()
...
func testSetup(cnf *config.Config) *scheduling_service.Server {
