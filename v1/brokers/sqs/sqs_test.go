...
import (
	...
	"github.com/ahlusar1989/scheduling_service/v1/brokers/iface"
	"github.com/ahlusar1989/scheduling_service/v1/brokers/sqs"
	"github.com/ahlusar1989/scheduling_service/v1/config"
	"github.com/ahlusar1989/scheduling_service/v1/retry"
...
func TestPrivateFunc_consume(t *testing.T) {
	server1, err := scheduling_service.NewServer(cnf)
	if err != nil {
		t.Fatal(err)
	}
